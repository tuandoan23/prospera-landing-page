...
const Mau: NextPage<Props> = ({}) => {
  ...
  return (
    <motion.div
      ...
      whileInView="visible"
      viewport={{ once: true }}
      className="min-w-36 rounded-2xl bg-gradient-to-br from-[#191919] to-[#101010] p-2 pb-0.5 sm:p-3"
    >
      ...
      <div className="relative">
        <div className="max-w-3/5">
          <h1 className="m-0 text-5xl font-bold">96k</h1>
          <p className="text-7b text-[9px]">Marketing Campaign effectives</p>
        </div>
...
const Chart = () => {
  return (
    <div className="relative max-w-3/5">
      <svg
        viewBox="0 0 230 115"
        fill="none"
